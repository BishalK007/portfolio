  ...
  const beams = [
    {
      ...
      repeatDelay: 3,
      delay: 2,
      className: "h-8 bg-gradient-to-t from-green-500 via-green-400 to-transparent", // Green beam with default height
    },
    {
      initialX: 600,
      translateX: 600,
      ...
      repeatDelay: 3,
      delay: 4,
      className: "h-10 bg-gradient-to-t from-green-600 via-green-500 to-transparent", // Slightly taller green beam
    },
    {
      initialX: 100,
      translateX: 100,
    ...
    },
    {
      ...
      repeatDelay: 14,
      delay: 4,
      className: "h-12 bg-gradient-to-t from-green-700 via-green-600 to-transparent", // Taller and darker green beam
    },
    {
      initialX: 800,
      translateX: 800,
      duration: 11,
      repeatDelay: 2,
      className: "h-20 bg-gradient-to-t from-green-500 via-green-400 to-transparent", // Tall green beam
    },
    {
      initialX: 1000,
      translateX: 1000,
      duration: 4,
      repeatDelay: 2,
      className: "h-12 bg-gradient-to-t from-green-600 via-green-500 to-transparent", // Moderate height green beam
    },
    {
      initialX: 1200,
      translateX: 1200,
